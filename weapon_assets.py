...
from PyQt6.QtCore import Qt, QRect, QCoreApplication, QTranslator
...
class WeaponAssetWindow(QDialog):
    ...
    def initUI(self):
        ...
        for button in [self.add_weapon_asset_button, self.correction_button, self.print_button, self.return_button]:
            button.setFont(QFont("강한공군체", 13, QFont.Weight.Bold))
    ...
    def handle_print_requested(self, printer):
        try:
            ...
            title_rect = painter.boundingRect(page_rect, Qt.AlignmentFlag.AlignTop | Qt.AlignmentFlag.AlignHCenter, "Missile Defense Systems Map")
            painter.drawText(title_rect, Qt.AlignmentFlag.AlignTop | Qt.AlignmentFlag.AlignHCenter, "Missile Defense Systems Map")
