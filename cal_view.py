...
class CalViewWindow(QtWidgets.QDialog, QObject):
    ...
    def handle_print_requested(self, printer):
        try:
            ...
            title_rect = painter.boundingRect(page_rect, Qt.AlignmentFlag.AlignTop | Qt.AlignmentFlag.AlignHCenter, self.tr("CAL 지도 보기"))
            painter.drawText(title_rect, Qt.AlignmentFlag.AlignTop | Qt.AlignmentFlag.AlignHCenter, self.tr("CAL 지도 보기"))
