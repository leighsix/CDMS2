...
class LogoTitleWidget(QWidget):
    def __init__(self, parent=None):
        ...
        self.logoLabel.setPixmap(logo_pixmap.scaled(50, 50,
        ...
        self.koreanLabel.setFont(QFont('맑은 고딕', 14, QFont.Weight.Bold))
        ...
        main_layout.setAlignment(Qt.AlignmentFlag.AlignLeft)  # 전체를 왼쪽 정렬
...
class RightArea(QGroupBox):
    ...
    def create_right_area(self, layout):
        ...
        settings_table.setVerticalScrollMode(QAbstractItemView.ScrollMode.ScrollPerPixel)
