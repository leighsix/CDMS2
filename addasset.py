from PyQt6 import QtWidgets  # PyQt5 위젯 관련 모듈 가져오기
from PyQt6.QtWidgets import *  # 모든 PyQt5 위젯을 사용하기 위해
from PyQt6.QtCore import Qt, QTranslator  # Qt 및 QTranslator 사용
...
from PyQt6.QtGui import QTextCursor, QTextTableFormat
from PyQt6.QtCore import Qt
import mgrs, re,json
...
class AddAssetWindow(QDialog, QObject):
    ...
    def initUI(self):
        ...
        for button in [self.save_button, self.print_button, self.back_button]:
            ...
            button.setFont(QFont("강한공군체", 15, QFont.Weight.Bold))
