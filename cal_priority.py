...
class CalPriorityWindow(QDialog):
    ...
    def handle_print_requested(self, printer):
        try:
            ...
            title_rect = painter.boundingRect(page_rect, Qt.AlignmentFlag.AlignTop | Qt.AlignmentFlag.AlignHCenter, self.tr("CAL 우선순위 지도 보기"))
            painter.drawText(title_rect, Qt.AlignmentFlag.AlignTop | Qt.AlignmentFlag.AlignHCenter, self.tr("CAL 우선순위 지도 보기"))
